...
public class RadioButtonGroup extends Composite implements HasClickHandlers, ClickHandler, HasValueChangeHandlers<Boolean>, ValueChangeHandler<Boolean> {
     ...
     *            
     */
    public RadioButtonGroup(final String radioButtonGroupId, final List<FieldValue> values, final String initialValue, final String itemsStyle, final boolean allowHTML) {
     ...
     *            
     */
    public RadioButtonGroup (final String radioButtonGroupId, final List<FieldValue> values, final String initialValue, final String itemsStyle, final boolean allowHTML, final boolean isElementOfMultipleWidget) {

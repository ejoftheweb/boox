package uk.co.platosys.platax.client.utils; 
...
return codes;}
public List<String> getNationNames(){  List<String> codes = new ArrayList<String>();
for(String code:NATIONS){
codes.add(code);
}
return codes;}
public List<String> getNationalityNames(){  List<String> codes = new ArrayList<String>();
for(String code:NATIONALITIES){
codes.add(code);
}
return codes;}
public Map<String, String> getNations(){  Map<String, String> nations = new TreeMap<String, String>();
int i=0;
for(String code:CODES){
...
return nations;}
public static Map<String, String> getNationalities(){  Map<String, String> nations = new TreeMap<String, String>();
int i=0;
for(String code:CODES){

...
public class CashierForm extends AbstractForm { 
	...
	//services
	final CashServiceAsync productService = (CashServiceAsync) GWT.create(CashService.class);
	//widgets
	FieldLabel cashierName = new FieldLabel(StringText.PRODUCT_NAME);
	FieldInfoLabel cashierNameInfo = new FieldInfoLabel(StringText.PRODUCT_NAME_INFO);
    final TextBox cashierNameBox= new TextBox();
  ...
  //callbacks
	...
	public CashierForm(Platax platax, final GWTEnterprise enterprise) {
		...
		//layout page
	    table.setWidget(0,0, cashierName);
	    table.setWidget(0,1, cashierNameBox);
	    table.setWidget(0,2, cashierNameInfo);
	...
	public CashierForm(Platax platax, final GWTEnterprise enterprise, PTab callingTab) {

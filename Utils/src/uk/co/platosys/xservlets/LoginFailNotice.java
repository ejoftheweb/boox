...
/**
 * This is a particular class of notice used to notify a user
 * when a login fails. There can be two possible reasons:
 * - bad(unknown) email; and
 * - bad(incorrect) password.
 *
 *
 * @author edward
 */
public class LoginFailNotice extends Notice {
   public static final String LOGIN_FAIL="Login Failed";
    public LoginFailNotice(){
        super(Notice.WARNING_TYPE, LOGIN_FAIL);
